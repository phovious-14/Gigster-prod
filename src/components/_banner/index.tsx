...
const Banner = () => {
  ...
  return (
    <section className="px-2 py-20 bg-white min-h-screen md:px-0 mt-24">
            ...
            <div className="w-full pb-6 space-y-6 font  sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
              <h1 className="text-5xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-5xl lg:text-5xl xl:text-5xl">
                ...
                &nbsp;&nbsp;Unlock Your{' '}
                  ...
                  <span>{' '} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; in Aptos Universe</span>                  
                </span>
              </h1>
              <p className="mx-auto text-base text-gray-500 sm:max-w-md font-mono lg:text-xl md:max-w-3xl text-center">
                {'>'}_ Contribute. Grow. Earn.
              </p>
              <section className="bg-white t">
                <div className="py-4">
                  <div className="flex justify-center items-center flex-row gap-8 text-gray-500 sm:gap-12 md:grid-cols-3  dark:text-gray-400 place-items-center">
              ...
              <div className="relative flex justify-center items-center flex-col sm:flex-row sm:space-x-4">
                <Link
                  href="/become-sponser"
