...
export default function Bounty() {
    return (
        <div className="w-full flex justify-start items-center flex-col h-[calc(100%_-100px)] overflow-x-hidden p-1 overflow-y-auto container2">
            <div className="bg-[#ffffff] w-full flex justify-start items-start flex-row p-4 rounded-lg shadow m-1">
                ...
                <div className="flex justify-center items-start flex-col ml-4">
                    <h1 className="text-slate-800 text-lg">Bounty name</h1>
                    ...
                    <div className="flex justify-evenly gap-4 items-center text-sm text-gray-500 font-light mt-4">
                        <span>🥇 50 APT</span>
                        <span>🥈 30 APT</span>
                        <span>🥉 20 APT</span>
                    </div>
