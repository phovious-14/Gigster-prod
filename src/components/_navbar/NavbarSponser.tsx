        ...
        <div className="container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
          <div className="relative flex flex-col md:flex-row">
            ...
            <nav className="flex flex-wrap items-center mb-5 text-base md:mb-0 md:pl-8 md:ml-8 md:border-l md:border-gray-200">
              <Link href="/sponser/create-gig" className="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">
                Create Gig
              </Link>
          ...
          <div className='w-[20%] flex justify-center items-center flex-row'>
              <Link href="/sponser/profile" className="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">
